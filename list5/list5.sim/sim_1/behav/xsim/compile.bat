...
REM
REM Generated by Vivado on Fri Aug 04 16:12:52 -0300 2023
...
echo "xvhdl --incr --relax -prj list1_5_tb_vhdl.prj"
call xvhdl  --incr --relax -prj list1_5_tb_vhdl.prj -log xvhdl.log
