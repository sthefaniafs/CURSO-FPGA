...
REM
REM Generated by Vivado on Fri Jul 28 15:16:00 -0300 2023
...
echo "xvhdl --incr --relax -prj list1_tb_vhdl.prj"
call xvhdl  --incr --relax -prj list1_tb_vhdl.prj -log xvhdl.log
